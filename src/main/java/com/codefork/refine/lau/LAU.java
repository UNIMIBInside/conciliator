...
@Component("lau")
public class LAU extends WebServiceDataSource {

    @Autowired
    public LAU(ApplicationConfig config, LAUConfig lauConfig, CacheManager cacheManager, ThreadPoolFactory threadPoolFactory, ConnectionFactory connectionFactory) {
    ...
    public ServiceMetaDataResponse createServiceMetaDataResponse(String baseUrl) {
        return new LAUMetaDataResponse(getName());
    }
